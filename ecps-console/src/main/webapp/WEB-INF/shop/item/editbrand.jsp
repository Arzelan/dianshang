...
<meta name="heading" content="修改品牌管理"/>
	...
	$("#form111").submit(function(){
		...
		$(this).find("[reg2]").each(function(){
			...
			if(!regObj.test(val)){
				...
				return false;//在jquery中return false可以结束each循环，别的不可以
			}else{
				$(this).next("span").html("");
			}
...
<div class="frameR"><div class="content">
	...
	<form id="form111" name="form111" action="${path }/brand/updateBrand.do" method="post" enctype="multipart/form-data">
		...
		<div class="edit set">
			<p><label><samp>*</samp>品牌名称：</label>${brand.brandName }<span></span>
			</p>
            <p><label class="alg_t"><samp>*</samp>品牌LOGO：</label><img id='imgsImgSrc' src="${pic}${brand.imgs}" height="100" width="100" />
            </p>
