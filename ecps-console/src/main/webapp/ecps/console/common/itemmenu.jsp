...
<ul class="ul">
<li><a href="${path}/item/selectItemByCondition.do?showStatus=1"><samp class="t05"></samp>商品录入/上下架</a></li>
...
<li><a href="${path}/feature/selectFeatureAll.do"><samp class="t05"></samp>属性管理</a></li>
<li><a href="${path}/brand/selectBrandAll.do"><samp class="t05"></samp>品牌管理</a></li>
</ul>
